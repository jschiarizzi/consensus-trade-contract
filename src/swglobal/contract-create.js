...
exports.createContractFromTx = exports.createContract = void 0;
/**
 ...
 */
function createContract(arweave, wallet, contractSrc, initState, minFee) {
    return __awaiter(this, void 0, void 0, function () {
        var srcTx, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, arweave.createTransaction({ data: contractSrc }, wallet)];
                case 1:
                    srcTx = _a.sent();
                    ...
                    return [4 /*yield*/, arweave.transactions.sign(srcTx, wallet)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, arweave.transactions.post(srcTx)];
                case 3:
                    response = _a.sent();
                    if ((response.status == 200) || (response.status == 208))
                        return [2 /*return*/, createContractFromTx(arweave, wallet, srcTx.id, initState, minFee)];
                    else
 ...
 */
function createContractFromTx(arweave, wallet, srcTxId, state, minFee) {
    return __awaiter(this, void 0, void 0, function () {
        var contractTX, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, arweave.createTransaction({ data: state }, wallet)];
                case 1:
                    contractTX = _a.sent();
                    ...
                    return [4 /*yield*/, arweave.transactions.sign(contractTX, wallet)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, arweave.transactions.post(contractTX)];
                case 3:
                    response = _a.sent();
                    if ((response.status == 200) || (response.status == 208))
                        return [2 /*return*/, contractTX.id];
                    else
